/*
 ...
 Source Schema         : config_config

 Target Server Type    : MySQL
 Target Server Version : 50744
 File Encoding         : 65001

 Date: 17/10/2024 15:10:57
*/

SET NAMES utf8mb4;
SET FOREIGN_KEY_CHECKS = 0;

CREATE database if NOT EXISTS `nacos-config` default character set utf8mb4;
use `nacos-config`;
...
(
    ...
    `encrypted_data_key` text CHARACTER SET utf8 COLLATE utf8_bin         NOT NULL COMMENT 'ç§˜é’¥',
