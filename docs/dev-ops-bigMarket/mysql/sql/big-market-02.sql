...
(
  ...
  COLLATE = utf8mb4_general_ci COMMENT = '抽奖活动账户表'
  ROW_FORMAT = Dynamic;
...
(
  ...
  AUTO_INCREMENT = 3
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT = '抽奖活动账户表-日次数'
  ROW_FORMAT = Dynamic;
...
(
  ...
  AUTO_INCREMENT = 3
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT = '抽奖活动账户表-月次数'
  ROW_FORMAT = Dynamic;
...
(
  ...
  AUTO_INCREMENT = 4
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT = '抽奖活动单'
  ROW_FORMAT = Dynamic;
...
(
  ...
  AUTO_INCREMENT = 24
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT = '任务表，发送MQ'
  ROW_FORMAT = Dynamic;
...
(
  ...
  AUTO_INCREMENT = 18
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT = '用户中奖记录表'
  ROW_FORMAT = Dynamic;
...
(
  ...
  AUTO_INCREMENT = 5
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT = '用户行为返利流水订单表'
  ROW_FORMAT = Dynamic;
...
(
  ...
  AUTO_INCREMENT = 3
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT = '用户积分账户'
  ROW_FORMAT = Dynamic;
...
(
  ...
  AUTO_INCREMENT = 4
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT = '用户积分订单记录'
  ROW_FORMAT = Dynamic;
...
(
  ...
  AUTO_INCREMENT = 18
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT = '用户抽奖订单表'
  ROW_FORMAT = Dynamic;
